...
- Installed starter check: verify the demo provider registry and authenticated routes for owning package recipes; provider discovery alone is not enough if the target package route still calls removed admin legacy APIs.
