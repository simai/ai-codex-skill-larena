...
- Package-owned admin demo provider: `Simai\DocaraAdmin\Support\Demo\DocaraAdminDemoProvider` exposes `docara.recipe.pages.tree` and `docara.recipe.editor.markdown_page`.
...
- Installed demo-provider smoke: verify registry membership plus authenticated 200 for `/admin/demo/recipes` and `/admin/docara/pages`.
